...
export class PageDescriptionPlus implements OnInit{
  ...
  addPlacesGroup(item: ListGroup) :void 
  {
    ...
    this.plusService.addPlacesGroup(this.authGuard.getIdUser(),this.pageDescriptionService.getIDPlace(),idGroup)
  ...
  {
    setTimeout(() => {
      this.router.navigate(['/description/place',this.pageDescriptionService.getIDPlace()]);
    },500);
  }
